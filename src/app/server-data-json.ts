export const SERVER_DATA = [
      ...
      },
      {
        ...
        source:[{value:1,text:'India'},{value:2,text:'Canada'}, {value:3,text:'USA'}]
      },
      {
        type:'select',
        name:'state',
        ...
        modelName:'state',
        filter:[{value:1,text:'Gujarat',countryId:1},{value:2,text:'Ontario',countryId:2},{value:3,text:'Massachusetts',countryId:3},{value:4,text:'Bihar',countryId:1}]
      },
      {
        type:'textarea',
